...
public:
   ...
   */
  int Top(int row, int col) const;

  int TopRight(int row, int col) const;

  int TopLeft(int row, int col) const;

  int Bottom(int row, int col) const;

  int BottomRight(int row, int col) const;

  int BottomLeft(int row, int col) const;

  int Left(int row, int col) const;

  int Right(int row, int col) const;

  int Middle(int row, int col) const;

  SeamCarver CalculateVerticalSeam() const;

  SeamCarver CalculateHorizontalSeam() const;
